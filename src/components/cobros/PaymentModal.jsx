...
const PaymentModal = ({ isOpen, onClose, onSubmit, venta }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-lg p-6 max-w-lg sm:max-w-2xl md:max-w-3xl lg:max-w-4xl xl:max-w-5xl w-full">
        ...
        <form onSubmit={handleSubmit} className="w-full">
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="flex-1 min-w-0 md:pl-2 md:pt-0 pt-6">
              <div className="bg-gray-50 p-3 rounded-md border md:sticky md:top-24">
